---
title: "dnmt3a_tet2_mutated_general"
author: "Sanketh"
date: "2024-01-02"
...
getwd()
dataDir <- ("/Users/sanketh/Desktop/proj1_tet_dnmt3a_mut/data/")
```

```{bash}
cd ./data
tar xvf GSE225773_RAW.tars
...
```{r}
#Reading in all the count files 
...
VlnPlot(merged_seurat, features = c("Ccr2", "Cd163"))
```
...
```{r}
#Subsetting all the wild type cells : 
```
